...
class Window:
    def __init__(self, ventana):
        ...
        tree.column("col1", width=100, minwidth=150, anchor="w")
        tree.column("col2", width=100, minwidth=100, anchor="w")
        tree.column("col3", width=70, minwidth=100, anchor="w")
        tree.column("col4", width=40, minwidth=100, anchor="w")
        tree.column("col5", width=130, minwidth=100, anchor="w")
        tree.column("col6", width=80, minwidth=50, anchor="w")
        tree.column("col7", width=120, minwidth=50, anchor="w")
